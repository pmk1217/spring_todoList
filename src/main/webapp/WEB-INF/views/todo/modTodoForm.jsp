...
<div class="main">
<div id="form">
	<form method="post"   action="${contextPath}/todo/modTodo.do">
	<h1  class="text_center">수정하기</h1>
	<table  align="center">
	   <tr>
	      <td width="100"><p align="right">목표 ! &nbsp;</p></td>
	      <td width="400"><input type="text" name="title"  value="${todo.title}" size="30"  required></td>
	    </tr>
	    <tr>
	       <td width="100"><p align="right">내용 ! &nbsp;</p></td>
	       <td width="400"><p><input type="text" name="content"   value="${todo.content}"  size="30"  required></td>
	    </tr>
	     <tr>
	       <td width="100"><p align="right">언제까지 ! &nbsp;</p></td>
	       <td width="400"><p><input type="date" name="deadline"  id="deadlineInput"  value="${fn:substring(todo.deadline, 0, 10)}"  style="width: 310px;" required></td>
	    </tr>
	     <tr>
	       ...
	       <td width="400">
	       	   ...
	       	   <c:choose>
	       	   		<c:when test="${todo.result == 'complete'}">
	       	   			<input type="radio" name="result" value="complete" checked> 완료
	       	   			<input type="radio" name="result" value="fail"> 실패
           				<input type="radio" name="result" value="pend"> 보류
	       	   		</c:when>
	       	   		<c:when test="${todo.result == 'fail'}">
	       	   			<input type="radio" name="result" value="complete"> 완료
	       	   			<input type="radio" name="result" value="fail" checked> 실패
	       	   			<input type="radio" name="result" value="pend"> 보류
	       	   		</c:when>
	       	   		<c:when test="${todo.result == 'pend'}">
	       	   		    <input type="radio" name="result" value="complete"> 완료
          				<input type="radio" name="result" value="fail"> 실패
	       	   			<input type="radio" name="result" value="pend" checked> 보류
	       	   		</c:when>
	       	   </c:choose>
	       	   </p>
	    ...
	    <tr>
	       ...
	       <input class="btn"  style="background-color: gray;" id="insert" type="submit" value="수정하기">
